...
const main = async () => {
  let {
    privKey, network, pkg, writerRole, rewardLedger, recipient, amount
  } = yargs.argv
  ...
  console.debug('reward data', { writerRole, rewardLedger, recipient, amount })

  const txb = new TransactionBlock()
  txb.moveCall({
    target: `${pkg}::reward::add_reward`,
    arguments: [
